...
@Component({
  selector: 'app-enhanced-product-card',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './enhanced-product-card.html',
  styleUrl: './enhanced-product-card.css'
})
export class EnhancedProductCardComponent {
  @Input() product: any;
